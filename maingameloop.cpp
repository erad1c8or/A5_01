...
const int FPS = 60;
//const float PI = 3.14159;			//commented out here becasue PI is now defined in explosion.cpp, although it should move again to a TRIG functions file probably

const int NumPlyr1Bullets = 10;
const int NumComets = 10;
const int NumParticles = 100;

const int NumPoints = 3;		//Redundenat???? - Think this was used for a Triangle array of some sorts but not sure.


//float dis;
//c11::uniform_real_distribution<> dis(1.0, 2.0);
